...
;	Messages
MSG_INTRO			db		"Hello! I am Cecil Hipplington-Shoreditch. The assembly module has started.",13,10
MSG_INTRO_LEN		equ		$-MSG_INTRO

;	For printf
PRINTF_ULONG		db		"%lu",13,10,0
; printf wont flush unless the string contains a newline, so put the CRLF directly in this string
...
demo_initLoop_top:					;	while( !(r14 > r13) )
